...
class CustomConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Background + tablet_pack
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        """Load the tablet_pack dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # Add classes. We have only one class to add.
        self.add_class("tablet_pack", 1, "tablet_pack")
        ...
        for a in annotations:
            ...
            try:
                ...
                self.add_image(
                    "tablet_pack",  ## for a single class just add the name here
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a tablet_pack dataset image, delegate to parent class.
        image_info = self.image_info[image_id]
        if image_info["source"] != "tablet_pack":
